...
const CTASection = () => {
  ...
  return (
    <div ref={sectionRef} className="py-16 md:py-24 relative">
      ...
      <div className="absolute -inset-10 bg-gradient-to-b from-primary/10 via-background/10 to-background-dark/10 blur-3xl -z-10"></div>
        ...
        <div className="relative glass-card rounded-xl p-8 md:p-12 overflow-hidden animate-fade-in-up">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center stagger">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/simulation">
                <Button size="lg" className="group hover-scale bg-gradient-to-r from-primary to-primary/80 hover:from-primary/80 hover:to-primary text-foreground font-sans">
                  Start Exploring
