...
const Benefit = ({ icon, title, description, color, delay = 0 }: BenefitProps) => (
  <div 
    className="p-6 rounded-xl backdrop-blur-md bg-background-dark/5 border border-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full flex flex-col"
...
const BenefitsSection = () => {
  const benefits = [
    ...
    },
    {
      ...
      color: "from-background/20 to-primary/20",
      delay: 300
    },
    {
      icon: <Gauge size={24} />,
  ...
  return (
    <section className="py-10 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-background/50 to-background-dark/50 pointer-events-none"></div>
      <div className="container mx-auto px-4">
        <ScrollReveal animation="fade-in">
          <div className="text-center mb-8">
            <span className="uppercase text-xs font-medium tracking-widest text-foreground/70 mb-2 block font-sans">Why Use Our Platform</span>
            <h2 className="mb-4 font-tech">
              <span className="text-foreground">Learning</span>
              <span className="ml-2 text-primary">Benefits</span>
            </h2>
